[@daiyam/artifact-test-mocha-ts](https://github.com/daiyam/artifact-configs/tree/master/packages/test-mocha-ts)
===============================================================================================================
...
cd myproject
npm init -y
artifact add @daiyam/lang-js @daiyam/lang-ts @daiyam/npm @daiyam/npm-ts @daiyam/test-mocha-ts
```
